...
define_languages! {
    ...
    interpreters : [], }, ALGOL => { name : "ALGOL", r#type : "programming", color :
    "#D1E0DB", extensions : [".alg"], aliases : [], tm_scope : "source.algol60", ace_mode
    : "pascal", language_id : 79217948u64, codemirror_mode : "pascal",
    codemirror_mime_type : "text/x-pascal", filenames : [], interpreters : [], }, AMPL =>
    { name : "AMPL", r#type : "programming", color : "#E6EFBB", extensions : [".ampl",
    ".mod"], aliases : [], tm_scope : "source.ampl", ace_mode : "text", language_id :
    3u64, filenames : [], interpreters : [], }, ANTLR => { name : "ANTLR", r#type :
    "programming", color : "#9DC3FF", extensions : [".g4"], aliases : [], tm_scope :
    "source.antlr", ace_mode : "text", language_id : 4u64, filenames : [], interpreters :
    [], }, APIBlueprint => { name : "API Blueprint", r#type : "markup", color :
    "#2ACCA8", extensions : [".apib"], aliases : [], tm_scope :
    ...
    language_id : 899409497u64, filenames : [], interpreters : [], }, Aleo => { name :
    "Aleo", r#type : "programming", color : "#154BF9", extensions : [".aleo"], aliases :
    [], tm_scope : "source.aleo", ace_mode : "text", language_id : 566431048u64,
    filenames : [], interpreters : [], }, Alloy => { name : "Alloy", r#type :
    "programming", color : "#64C800", extensions : [".als"], aliases : [], tm_scope :
    "source.alloy", ace_mode : "text", language_id : 13u64, filenames : [], interpreters
    : [], }, AlpineAbuild => { name : "Alpine Abuild", r#type : "programming", color :
    "#0D597F", extensions : [], aliases : ["abuild", "apkbuild"], tm_scope :
    "source.shell", ace_mode : "sh", language_id : 14u64, codemirror_mode : "shell",
    codemirror_mime_type : "text/x-sh", filenames : ["APKBUILD"], group : "Shell",
    interpreters : [], }, AltiumDesigner => { name : "Altium Designer", r#type : "data",
    color : "#A89663", extensions : [".OutJob", ".PcbDoc", ".PrjPCB", ".SchDoc"], aliases
    : ["altium"], tm_scope : "source.ini", ace_mode : "ini", language_id : 187772328u64,
    filenames : [], interpreters : [], }, AngelScript => { name : "AngelScript", r#type :
    "programming", color : "#C7D7DC", extensions : [".as", ".angelscript"], aliases : [],
    tm_scope : "source.angelscript", ace_mode : "text", language_id : 389477596u64,
    codemirror_mode : "clike", codemirror_mime_type : "text/x-c++src", filenames : [],
    interpreters : [], }, AnswerSetProgramming => { name : "Answer Set Programming",
    r#type : "programming", color : "#A9CC29", extensions : [".lp"], aliases : [],
    tm_scope : "source.answersetprogramming", ace_mode : "prolog", language_id :
    433009171u64, filenames : [], interpreters : ["clingo"], }, AntBuildSystem => { name
    ...
    : "source.apex", ace_mode : "apex", language_id : 17u64, codemirror_mode : "clike",
    ...
    ["apples", "osascript"], tm_scope : "source.applescript", ace_mode : "applescript",
    ...
    "nawk"], }, BFormalMethod => { name : "B (Formal Method)", r#type : "programming",
    color : "#8aa8c5", extensions : [".mch"], aliases : [], tm_scope : "source.b",
    ace_mode : "text", language_id : 700792152u64, filenames : [], interpreters : [], },
    B4X => { name : "B4X", r#type : "programming", color : "#00e4ff", extensions :
    [".bas"], aliases : ["basic for android"], tm_scope : "source.vba", ace_mode :
    "text", language_id : 96642275u64, codemirror_mode : "vb", codemirror_mime_type :
    "text/x-vb", filenames : [], interpreters : [], }, BAML => { name : "BAML", r#type :
    "programming", color : "#a855f7", extensions : [".baml"], aliases : [], tm_scope :
    "source.baml", ace_mode : "io", language_id : 502521509u64, codemirror_mode :
    "stylus", codemirror_mime_type : "text/x-styl", filenames : [], interpreters : [], },
    BASIC => { name : "BASIC", r#type : "programming", color : "#ff0000", extensions :
    [".bas"], aliases : [], tm_scope : "source.basic", ace_mode : "basic", language_id :
    28923963u64, filenames : [], interpreters : [], }, BBCode => { name : "BBCode",
    r#type : "markup", color : "#CAFF42", extensions : [".bbcode"], aliases : [],
    tm_scope : "text.bbcode", ace_mode : "text", language_id : 206921123u64, filenames :
    [], interpreters : [], }, BIRD2 => { name : "BIRD2", r#type : "data", color :
    "#b6d7e4", extensions : [], aliases : ["bird", "bird3"], tm_scope : "source.bird2",
    ace_mode : "text", language_id : 584191811u64, filenames : ["bird.conf"],
    ...
    ["gradlew.bat", "mvnw.cmd"], interpreters : [], }, Beef => { name : "Beef", r#type :
    "programming", color : "#a52f4e", extensions : [".bf"], aliases : [], tm_scope :
    "source.cs", ace_mode : "csharp", language_id : 545626333u64, codemirror_mode :
    "clike", codemirror_mime_type : "text/x-csharp", filenames : [], interpreters : [],
    }, Befunge => { name : "Befunge", r#type : "programming", color : "#000000",
    extensions : [".befunge", ".bf"], aliases : [], tm_scope : "source.befunge", ace_mode
    : "text", language_id : 30u64, filenames : [], interpreters : [], }, Berry => { name
    : "Berry", r#type : "programming", color : "#15A13C", extensions : [".be"], aliases :
    ["be"], tm_scope : "source.berry", ace_mode : "text", language_id : 121855308u64,
    filenames : [], interpreters : [], }, BibTeX => { name : "BibTeX", r#type : "markup",
    color : "#778899", extensions : [".bib", ".bibtex"], aliases : [], tm_scope :
    "text.bibtex", ace_mode : "bibtex", language_id : 982188347u64, codemirror_mode :
    "stex", codemirror_mime_type : "text/x-stex", filenames : [], group : "TeX",
    interpreters : [], }, BibTeXStyle => { name : "BibTeX Style", r#type : "programming",
    color : "#000000", extensions : [".bst"], aliases : [], tm_scope : "source.bst",
    ace_mode : "text", language_id : 909569041u64, filenames : [], interpreters : [], },
    Bicep => { name : "Bicep", r#type : "programming", color : "#519aba", extensions :
    [".bicep", ".bicepparam"], aliases : [], tm_scope : "source.bicep", ace_mode :
    "text", language_id : 321200902u64, filenames : [], interpreters : [], }, Bikeshed =>
    { name : "Bikeshed", r#type : "markup", color : "#5562ac", extensions : [".bs"],
    aliases : [], tm_scope : "source.csswg", ace_mode : "html", language_id :
    1055528081u64, codemirror_mode : "htmlmixed", codemirror_mime_type : "text/html",
    filenames : [], interpreters : [], }, Bison => { name : "Bison", r#type :
    "programming", color : "#6A463F", extensions : [".bison"], aliases : [], tm_scope :
    "source.yacc", ace_mode : "text", language_id : 31u64, filenames : [], group :
    "Yacc", interpreters : [], }, BitBake => { name : "BitBake", r#type : "programming",
    color : "#00bce4", extensions : [".bb", ".bbappend", ".bbclass", ".inc"], aliases :
    [], tm_scope : "source.bb", ace_mode : "text", language_id : 32u64, filenames : [],
    interpreters : [], }, Blade => { name : "Blade", r#type : "markup", color :
    "#f7523f", extensions : [".blade", ".blade.php"], aliases : [], tm_scope :
    "text.html.php.blade", ace_mode : "php_laravel_blade", language_id : 33u64, filenames
    : [], interpreters : [], }, BlitzBasic => { name : "BlitzBasic", r#type :
    "programming", color : "#00FFAE", extensions : [".bb", ".decls"], aliases : ["b3d",
    "blitz3d", "blitzplus", "bplus"], tm_scope : "source.blitzmax", ace_mode : "text",
    language_id : 34u64, filenames : [], interpreters : [], }, BlitzMax => { name :
    "BlitzMax", r#type : "programming", color : "#cd6400", extensions : [".bmx"], aliases
    : ["bmax"], tm_scope : "source.blitzmax", ace_mode : "text", language_id : 35u64,
    filenames : [], interpreters : [], }, Blueprint => { name : "Blueprint", r#type :
    "markup", color : "#3584E4", extensions : [".blp"], aliases : ["blp"], tm_scope :
    "source.blueprint", ace_mode : "text", language_id : 765545512u64, filenames : [],
    interpreters : [], }, Bluespec => { name : "Bluespec", r#type : "programming", color
    : "#12223c", extensions : [".bsv"], aliases : ["bluespec bsv", "bsv"], tm_scope :
    "source.bsv", ace_mode : "verilog", language_id : 36u64, codemirror_mode : "verilog",
    ...
    ["cask", "eask", "elisp", "emacs"], tm_scope : "source.emacs.lisp", ace_mode :
    "lisp", language_id : 102u64, codemirror_mode : "commonlisp", codemirror_mime_type :
    "text/x-common-lisp", filenames : [".abbrev_defs", ".emacs", ".emacs.desktop",
    ".gnus", ".spacemacs", ".viper", "Cask", "Eask", "Project.ede", "_emacs",
    "abbrev_defs"], interpreters : [], }, EmberScript => { name : "EmberScript", r#type :
    "programming", color : "#FFF4F3", extensions : [".em", ".emberscript"], aliases : [],
    tm_scope : "source.coffee", ace_mode : "coffee", language_id : 103u64,
    codemirror_mode : "coffeescript", codemirror_mime_type : "text/x-coffeescript",
    filenames : [], interpreters : [], }, Erlang => { name : "Erlang", r#type :
    "programming", color : "#B83998", extensions : [".erl", ".app", ".app.src", ".es",
    ".escript", ".hrl", ".xrl", ".yrl"], aliases : [], tm_scope : "source.erlang",
    ace_mode : "erlang", language_id : 104u64, codemirror_mode : "erlang",
    codemirror_mime_type : "text/x-erlang", filenames : ["Emakefile", "rebar.config",
    "rebar.config.lock", "rebar.lock"], interpreters : ["escript"], }, Euphoria => { name
    : "Euphoria", r#type : "programming", color : "#FF790B", extensions : [".e", ".ex"],
    aliases : [], tm_scope : "source.euphoria", ace_mode : "text", language_id :
    880693982u64, filenames : [], interpreters : ["eui", "euiw"], }, Fsharp => { name :
    "F#", r#type : "programming", color : "#b845fc", extensions : [".fs", ".fsi",
    ".fsx"], aliases : ["fsharp"], tm_scope : "source.fsharp", ace_mode : "fsharp",
    language_id : 105u64, codemirror_mode : "mllike", codemirror_mime_type :
    "text/x-fsharp", filenames : [], interpreters : [], }, Fstar => { name : "F*", r#type
    : "programming", color : "#572e30", extensions : [".fst", ".fsti"], aliases :
    ["fstar"], tm_scope : "source.fstar", ace_mode : "text", language_id : 336943375u64,
    filenames : [], interpreters : [], fs_name : "Fstar", }, FIGletFont => { name :
    "FIGlet Font", r#type : "data", color : "#FFDDBB", extensions : [".flf"], aliases :
    ["FIGfont"], tm_scope : "source.figfont", ace_mode : "text", language_id :
    686129783u64, filenames : [], interpreters : [], }, FIRRTL => { name : "FIRRTL",
    r#type : "programming", color : "#2f632f", extensions : [".fir"], aliases : [],
    ...
    : "application/x-jsp", filenames : [], group : "Groovy", interpreters : [], }, GtkRC
    => { name : "GtkRC", r#type : "data", color : "#7fe719", extensions : [".gtkrc"],
    aliases : ["gtk", "gtk 1", "gtk 2"], tm_scope : "source.gtkrc", ace_mode : "ruby",
    language_id : 876401352u64, codemirror_mode : "ruby", codemirror_mime_type :
    "text/x-ruby", filenames : ["gtkrc", "gtkrc-2.0"], interpreters : [], }, HAProxy => {
    name : "HAProxy", r#type : "data", color : "#106da9", extensions : [".cfg"], aliases
    : [], tm_scope : "source.haproxy-config", ace_mode : "text", language_id :
    366607477u64, filenames : ["haproxy.cfg"], interpreters : [], }, HCL => { name :
    "HCL", r#type : "programming", color : "#844FBA", extensions : [".hcl", ".nomad",
    ".tf", ".tfvars", ".tofu", ".workflow"], aliases :
    ["HashiCorp Configuration Language", "opentofu", "terraform"], tm_scope :
    "source.hcl", ace_mode : "terraform", language_id : 144u64, codemirror_mode : "ruby",
    codemirror_mime_type : "text/x-ruby", filenames : [], interpreters : [], }, HIP => {
    name : "HIP", r#type : "programming", color : "#4F3A4F", extensions : [".hip"],
    aliases : [], tm_scope : "source.c++", ace_mode : "c_cpp", language_id :
    674379998u64, codemirror_mode : "clike", codemirror_mime_type : "text/x-c++src",
    filenames : [], interpreters : [], }, HLSL => { name : "HLSL", r#type :
    "programming", color : "#aace60", extensions : [".hlsl", ".cginc", ".fx", ".fxh",
    ".hlsli"], aliases : [], tm_scope : "source.hlsl", ace_mode : "text", language_id :
    145u64, filenames : [], interpreters : [], }, HOCON => { name : "HOCON", r#type :
    "data", color : "#9ff8ee", extensions : [".hocon"], aliases : [], tm_scope :
    "source.hocon", ace_mode : "text", language_id : 679725279u64, filenames :
    [".scalafix.conf", ".scalafmt.conf"], interpreters : [], }, HTML => { name : "HTML",
    r#type : "markup", color : "#e34c26", extensions : [".html", ".hta", ".htm",
    ".html.hl", ".inc", ".xht", ".xhtml"], aliases : ["xhtml"], tm_scope :
    ...
    "text", language_id : 162u64, filenames : [], interpreters : [], }, ILAssembly => {
    name : "IL Assembly", r#type : "programming", color : "#512BD4", extensions :
    [".il"], aliases : ["ilasm", "msil"], tm_scope : "source.il", ace_mode : "text",
    language_id : 592065806u64, filenames : [], interpreters : [], }, INI => { name :
    "INI", r#type : "data", color : "#d1dbe0", extensions : [".ini", ".cfg", ".cnf",
    ".container", ".dof", ".frm", ".lektorproject", ".mount", ".network", ".prefs",
    ...
    ["MANIFEST.MF"], interpreters : [], }, JASS => { name : "JASS", r#type :
    "programming", color : "#FF0303", extensions : [".j"], aliases : ["jass2"], tm_scope
    : "source.jass", ace_mode : "text", language_id : 504860504u64, filenames : [],
    ...
    [".jsonc", ".code-snippets", ".code-workspace", ".hujson", ".sublime-build",
    ...
    "source.java-properties", ace_mode : "properties", language_id : 519377561u64,
    codemirror_mode : "properties", codemirror_mime_type : "text/x-properties", filenames
    : [], interpreters : [], }, JavaServerPages => { name : "Java Server Pages", r#type :
    "programming", color : "#2A6277", extensions : [".jsp", ".tag"], aliases : ["jsp"],
    tm_scope : "text.html.jsp", ace_mode : "jsp", language_id : 182u64, codemirror_mode :
    ...
    ["bun", "chakra", "d8", "deno", "gjs", "js", "node", "nodejs", "qjs", "rhino", "v8",
    "v8-shell"], }, JavaScriptpERB => { name : "JavaScript+ERB", r#type : "programming",
    color : "#f1e05a", extensions : [".js.erb"], aliases : [], tm_scope : "source.js",
    ace_mode : "javascript", language_id : 914318960u64, codemirror_mode : "javascript",
    ...
    : ["Slakefile"], interpreters : [], }, Lobster => { name : "Lobster", r#type :
    "programming", color : "#f95428", extensions : [".lobster"], aliases : [], tm_scope :
    "source.lobster", ace_mode : "python", language_id : 790066842u64, filenames : [],
    interpreters : [], }, Logos => { name : "Logos", r#type : "programming", color :
    "#000000", extensions : [".xm", ".x", ".xi"], aliases : [], tm_scope :
    "source.logos", ace_mode : "text", language_id : 209u64, filenames : [], interpreters
    : [], }, Logtalk => { name : "Logtalk", r#type : "programming", color : "#295b9a",
    extensions : [".lgt", ".logtalk"], aliases : [], tm_scope : "source.logtalk",
    ace_mode : "logtalk", language_id : 210u64, filenames : [], interpreters : [], },
    LookML => { name : "LookML", r#type : "programming", color : "#652B81", extensions :
    [".lkml", ".lookml"], aliases : [], tm_scope : "source.yaml", ace_mode : "yaml",
    language_id : 211u64, codemirror_mode : "yaml", codemirror_mime_type : "text/x-yaml",
    filenames : [], interpreters : [], }, LoomScript => { name : "LoomScript", r#type :
    "programming", color : "#000000", extensions : [".ls"], aliases : [], tm_scope :
    "source.loomscript", ace_mode : "text", language_id : 212u64, filenames : [],
    interpreters : [], }, Lua => { name : "Lua", r#type : "programming", color :
    "#000080", extensions : [".lua", ".fcgi", ".nse", ".p8", ".pd_lua", ".rbxs",
    ".rockspec", ".wlua"], aliases : [], tm_scope : "source.lua", ace_mode : "lua",
    language_id : 213u64, codemirror_mode : "lua", codemirror_mime_type : "text/x-lua",
    filenames : [".luacheckrc"], interpreters : ["lua", "luajit"], }, Luau => { name :
    "Luau", r#type : "programming", color : "#00A2FF", extensions : [".luau"], aliases :
    [], tm_scope : "source.luau", ace_mode : "lua", language_id : 365050359u64,
    codemirror_mode : "lua", codemirror_mime_type : "text/x-lua", filenames : [],
    interpreters : ["luau"], }, M => { name : "M", r#type : "programming", color :
    "#000000", extensions : [".mumps", ".m"], aliases : ["mumps"], tm_scope : "none",
    ace_mode : "text", language_id : 214u64, codemirror_mode : "mumps",
    codemirror_mime_type : "text/x-mumps", filenames : [], interpreters : [], }, M3U => {
    name : "M3U", r#type : "data", color : "#179C7D", extensions : [".m3u", ".m3u8"],
    aliases : ["hls playlist", "m3u playlist"], tm_scope : "source.m3u", ace_mode :
    "text", language_id : 89638692u64, filenames : [], interpreters : [], }, M4 => { name
    : "M4", r#type : "programming", color : "#000000", extensions : [".m4", ".mc"],
    aliases : [], tm_scope : "source.m4", ace_mode : "text", language_id : 215u64,
    filenames : [], interpreters : [], }, M4Sugar => { name : "M4Sugar", r#type :
    ...
    "Makefile.frag", "Makefile.in", "Makefile.inc", "Makefile.pc", "Makefile.wat",
    "makefile", "makefile.sco", "mkfile"], interpreters : ["make"], }, Mako => { name :
    "Mako", r#type : "programming", color : "#7e858d", extensions : [".mako", ".mao"],
    aliases : [], tm_scope : "text.html.mako", ace_mode : "text", language_id : 221u64,
    filenames : [], interpreters : [], }, Markdown => { name : "Markdown", r#type :
    "prose", color : "#083fa1", extensions : [".md", ".livemd", ".markdown", ".mdown",
    ".mdwn", ".mkd", ".mkdn", ".mkdown", ".ronn", ".scd", ".workbook"], aliases : ["md",
    "pandoc"], tm_scope : "text.md", ace_mode : "markdown", language_id : 222u64,
    codemirror_mode : "gfm", codemirror_mime_type : "text/x-gfm", wrap : true, filenames
    : ["contents.lr"], interpreters : [], }, Marko => { name : "Marko", r#type :
    "markup", color : "#42bff2", extensions : [".marko"], aliases : ["markojs"], tm_scope
    : "text.marko", ace_mode : "text", language_id : 932782397u64, codemirror_mode :
    "htmlmixed", codemirror_mime_type : "text/html", filenames : [], interpreters : [],
    }, Mask => { name : "Mask", r#type : "markup", color : "#f97732", extensions :
    [".mask"], aliases : [], tm_scope : "source.mask", ace_mode : "mask", language_id :
    223u64, filenames : [], interpreters : [], }, MathematicalProgrammingSystem => { name
    : "Mathematical Programming System", r#type : "programming", color : "#0530ad",
    extensions : [".mps"], aliases : [], tm_scope : "text.source.mps", ace_mode : "text",
    language_id : 429002699u64, filenames : [], interpreters : [], }, MavenPOM => { name
    ...
    filenames : [], interpreters : [], }, MeTTa => { name : "MeTTa", r#type :
    "programming", color : "#6a5acd", extensions : [".metta"], aliases : [], tm_scope :
    "source.metta", ace_mode : "text", language_id : 1037612668u64, filenames : [],
    interpreters : [], }, Mercury => { name : "Mercury", r#type : "programming", color :
    "#ff2b2b", extensions : [".m", ".moo"], aliases : [], tm_scope : "source.mercury",
    ace_mode : "prolog", language_id : 229u64, filenames : [], interpreters : ["mmi"], },
    Mermaid => { name : "Mermaid", r#type : "markup", color : "#ff3670", extensions :
    [".mmd", ".mermaid"], aliases : ["mermaid example"], tm_scope : "source.mermaid",
    ace_mode : "text", language_id : 385992043u64, filenames : [], interpreters : [], },
    Meson => { name : "Meson", r#type : "programming", color : "#007800", extensions :
    [], aliases : [], tm_scope : "source.meson", ace_mode : "text", language_id :
    799141244u64, filenames : ["meson.build", "meson_options.txt"], interpreters : [], },
    Metal => { name : "Metal", r#type : "programming", color : "#8f14e9", extensions :
    [".metal"], aliases : [], tm_scope : "source.c++", ace_mode : "c_cpp", language_id :
    230u64, codemirror_mode : "clike", codemirror_mime_type : "text/x-c++src", filenames
    ...
    interpreters : [], }, MiniScript => { name : "MiniScript", r#type : "programming",
    color : "#4B4A56", extensions : [".ms"], aliases : [], tm_scope : "source.ms",
    ace_mode : "text", language_id : 704299647u64, filenames : [], interpreters : [], },
    MiniYAML => { name : "MiniYAML", r#type : "data", color : "#ff1111", extensions :
    [".yaml", ".yml"], aliases : [], tm_scope : "source.miniyaml", ace_mode : "yaml",
    language_id : 4896465u64, codemirror_mode : "yaml", codemirror_mime_type :
    "text/x-yaml", filenames : [], interpreters : [], }, MiniZinc => { name : "MiniZinc",
    r#type : "programming", color : "#06a9e6", extensions : [".mzn"], aliases : [],
    tm_scope : "source.mzn", ace_mode : "text", language_id : 238874535u64, filenames :
    [], interpreters : [], }, MiniZincData => { name : "MiniZinc Data", r#type : "data",
    color : "#000000", extensions : [".dzn"], aliases : [], tm_scope : "source.mzn",
    ace_mode : "text", language_id : 938193433u64, filenames : [], interpreters : [], },
    Mint => { name : "Mint", r#type : "programming", color : "#02b046", extensions :
    [".mint"], aliases : [], tm_scope : "source.mint", ace_mode : "text", language_id :
    968740319u64, filenames : [], interpreters : [], }, Mirah => { name : "Mirah", r#type
    : "programming", color : "#c7a938", extensions : [".druby", ".duby", ".mirah"],
    aliases : [], tm_scope : "source.ruby", ace_mode : "ruby", language_id : 232u64,
    ...
    wrap : true, filenames : [], interpreters : [], }, OverPy => { name : "OverPy",
    r#type : "programming", color : "#78b355", extensions : [".opy"], aliases : ["opy"],
    tm_scope : "source.opy", ace_mode : "python", language_id : 492781155u64,
    codemirror_mode : "python", codemirror_mime_type : "text/x-python", wrap : true,
    filenames : [], interpreters : [], }, OverpassQL => { name : "OverpassQL", r#type :
    "programming", color : "#cce2aa", extensions : [".overpassql"], aliases : [],
    tm_scope : "source.overpassql", ace_mode : "text", language_id : 689079655u64, wrap :
    true, filenames : [], interpreters : [], }, Ox => { name : "Ox", r#type :
    "programming", color : "#000000", extensions : [".ox", ".oxh", ".oxo"], aliases : [],
    tm_scope : "source.ox", ace_mode : "text", language_id : 268u64, filenames : [],
    interpreters : [], }, Oxygene => { name : "Oxygene", r#type : "programming", color :
    "#cdd0e3", extensions : [".oxygene"], aliases : [], tm_scope : "none", ace_mode :
    "text", language_id : 269u64, filenames : [], interpreters : [], }, Oz => { name :
    "Oz", r#type : "programming", color : "#fab738", extensions : [".oz"], aliases : [],
    tm_scope : "source.oz", ace_mode : "text", language_id : 270u64, codemirror_mode :
    "oz", codemirror_mime_type : "text/x-oz", filenames : [], interpreters : [], }, P4 =>
    { name : "P4", r#type : "programming", color : "#7055b5", extensions : [".p4"],
    aliases : [], tm_scope : "source.p4", ace_mode : "text", language_id : 348895984u64,
    filenames : [], interpreters : [], }, PDDL => { name : "PDDL", r#type :
    "programming", color : "#0d00ff", extensions : [".pddl"], aliases : [], tm_scope :
    "source.pddl", ace_mode : "text", language_id : 736235603u64, filenames : [],
    interpreters : [], }, PEGjs => { name : "PEG.js", r#type : "programming", color :
    "#234d6b", extensions : [".pegjs", ".peggy"], aliases : [], tm_scope :
    "source.peggy", ace_mode : "javascript", language_id : 81442128u64, codemirror_mode :
    "javascript", codemirror_mime_type : "text/javascript", filenames : [], interpreters
    : [], }, PHP => { name : "PHP", r#type : "programming", color : "#4F5D95", extensions
    : [".php", ".aw", ".ctp", ".fcgi", ".inc", ".php3", ".php4", ".php5", ".phps",
    ".phpt"], aliases : ["inc"], tm_scope : "text.html.php", ace_mode : "php",
    language_id : 272u64, codemirror_mode : "php", codemirror_mime_type :
    ...
    filenames : [], interpreters : [], }, PowerQuery => { name : "Power Query", r#type :
    "programming", color : "#d38e0d", extensions : [".pq"], aliases : ["powerquery"],
    tm_scope : "source.powerquery", ace_mode : "text", language_id : 37496382u64,
    ...
    interpreters : [], }, ProstarC => { name : "Pro*C", r#type : "programming", color :
    "#bb8368", extensions : [".pc"], aliases : [], tm_scope : "source.c", ace_mode :
    "c_cpp", language_id : 991047534u64, codemirror_mode : "clike", codemirror_mime_type
    : "text/x-csrc", filenames : [], interpreters : [], fs_name : "ProC", }, Processing
    => { name : "Processing", r#type : "programming", color : "#0096D8", extensions :
    [".pde"], aliases : [], tm_scope : "source.processing", ace_mode : "text",
    language_id : 294u64, filenames : [], interpreters : [], }, Procfile => { name :
    "Procfile", r#type : "programming", color : "#3B2F63", extensions : [], aliases : [],
    tm_scope : "source.procfile", ace_mode : "batchfile", language_id : 305313959u64,
    filenames : ["Procfile"], interpreters : [], }, Proguard => { name : "Proguard",
    r#type : "data", color : "#000000", extensions : [".pro"], aliases : [], tm_scope :
    "none", ace_mode : "text", language_id : 716513858u64, filenames : [], interpreters :
    [], }, Prolog => { name : "Prolog", r#type : "programming", color : "#74283c",
    extensions : [".pl", ".plt", ".pro", ".prolog", ".yap"], aliases : [], tm_scope :
    "source.prolog", ace_mode : "prolog", language_id : 295u64, filenames : [],
    interpreters : ["swipl", "yap"], }, Promela => { name : "Promela", r#type :
    "programming", color : "#de0000", extensions : [".pml"], aliases : [], tm_scope :
    "source.promela", ace_mode : "text", language_id : 441858312u64, filenames : [],
    interpreters : [], }, PropellerSpin => { name : "Propeller Spin", r#type :
    "programming", color : "#7fa2a7", extensions : [".spin"], aliases : [], tm_scope :
    "source.spin", ace_mode : "text", language_id : 296u64, filenames : [], interpreters
    : [], }, ProtocolBuffer => { name : "Protocol Buffer", r#type : "data", color :
    "#000000", extensions : [".proto"], aliases : ["proto", "protobuf",
    "Protocol Buffers"], tm_scope : "source.proto", ace_mode : "protobuf", language_id :
    297u64, codemirror_mode : "protobuf", codemirror_mime_type : "text/x-protobuf",
    filenames : [], interpreters : [], }, ProtocolBufferTextFormat => { name :
    "Protocol Buffer Text Format", r#type : "data", color : "#000000", extensions :
    [".textproto", ".pbt", ".pbtxt", ".txtpb"], aliases : ["text proto",
    ...
    aliases : ["py", "py3", "python3", "rusthon"], tm_scope : "source.python", ace_mode :
    "python", language_id : 303u64, codemirror_mode : "python", codemirror_mime_type :
    ...
    }, Redscript => { name : "Redscript", r#type : "programming", color : "#f44336",
    extensions : [".reds"], aliases : [], tm_scope : "source.redscript", ace_mode :
    "text", language_id : 686691365u64, filenames : [], interpreters : [], },
    ...
    "Puppetfile", "Rakefile", "Snapfile", "Steepfile", "Thorfile", "Vagrantfile",
    "buildfile"], interpreters : ["ruby", "macruby", "rake", "jruby", "rbx"], }, Rust =>
    { name : "Rust", r#type : "programming", color : "#dea584", extensions : [".rs",
    ".rs.in"], aliases : ["rs"], tm_scope : "source.rust", ace_mode : "rust", language_id
    : 327u64, codemirror_mode : "rust", codemirror_mime_type : "text/x-rustsrc",
    filenames : [], interpreters : ["rust-script"], }, SAS => { name : "SAS", r#type :
    "programming", color : "#B34936", extensions : [".sas"], aliases : [], tm_scope :
    "source.sas", ace_mode : "text", language_id : 328u64, codemirror_mode : "sas",
    codemirror_mime_type : "text/x-sas", filenames : [], interpreters : [], }, SCSS => {
    name : "SCSS", r#type : "markup", color : "#c6538c", extensions : [".scss"], aliases
    : [], tm_scope : "source.css.scss", ace_mode : "scss", language_id : 329u64,
    codemirror_mode : "css", codemirror_mime_type : "text/x-scss", filenames : [],
    interpreters : [], }, SELinuxPolicy => { name : "SELinux Policy", r#type : "data",
    ...
    "text", language_id : 1029438153u64, filenames : [], interpreters : [], }, Salt => {
    name : "Salt", r#type : "programming", color : "#57bcad", extensions : [".sls"],
    aliases : ["saltstack", "saltstate"], tm_scope : "source.yaml.salt", ace_mode :
    ...
    ".ksh", ".pacscript", ".sbatch", ".sh.in", ".slurm", ".tmux", ".tool", ".trigger",
    ".zsh", ".zsh-theme"], aliases : ["sh", "shell-script", "bash", "zsh", "envrc"],
    tm_scope : "source.shell", ace_mode : "sh", language_id : 346u64, codemirror_mode :
    "shell", codemirror_mime_type : "text/x-sh", filenames : [".bash_aliases",
    ".bash_functions", ".bash_history", ".bash_logout", ".bash_profile", ".bashrc",
    ".cshrc", ".envrc", ".flaskenv", ".kshrc", ".login", ".profile", ".tmux.conf",
    ".xinitrc", ".xsession", ".zlogin", ".zlogout", ".zprofile", ".zshenv", ".zshrc",
    "9fs", "PKGBUILD", "bash_aliases", "bash_logout", "bash_profile", "bashrc", "cshrc",
    "gradlew", "kshrc", "login", "man", "mvnw", "profile", "tmux.conf", "xinitrc",
    "xsession", "zlogin", "zlogout", "zprofile", "zshenv", "zshrc"], interpreters :
    ...
    interpreters : [], }, SpiceDBSchema => { name : "SpiceDB Schema", r#type : "data",
    color : "#a5318a", extensions : [".zed"], aliases : [], tm_scope : "source.spicedb",
    ace_mode : "text", language_id : 864005057u64, filenames : [], interpreters : [], },
    SplineFontDatabase => { name : "Spline Font Database", r#type : "data", color :
    "#000000", extensions : [".sfd"], aliases : [], tm_scope : "text.sfd", ace_mode :
    "yaml", language_id : 767169629u64, filenames : [], interpreters : [], }, Squirrel =>
    { name : "Squirrel", r#type : "programming", color : "#800000", extensions :
    [".nut"], aliases : [], tm_scope : "source.nut", ace_mode : "c_cpp", language_id :
    355u64, codemirror_mode : "clike", codemirror_mime_type : "text/x-squirrel",
    filenames : [], interpreters : [], }, Stan => { name : "Stan", r#type :
    "programming", color : "#b2011d", extensions : [".stan"], aliases : [], tm_scope :
    "source.stan", ace_mode : "text", language_id : 356u64, filenames : [], interpreters
    : [], }, StandardML => { name : "Standard ML", r#type : "programming", color :
    "#dc566d", extensions : [".ml", ".fun", ".sig", ".sml"], aliases : ["sml"], tm_scope
    : "source.ml", ace_mode : "text", language_id : 357u64, codemirror_mode : "mllike",
    codemirror_mime_type : "text/x-sml", filenames : [], interpreters : [], }, Starlark
    => { name : "Starlark", r#type : "programming", color : "#76d275", extensions :
    [".bzl", ".star"], aliases : ["bazel", "bzl"], tm_scope : "source.python", ace_mode :
    "python", language_id : 960266174u64, codemirror_mode : "python",
    codemirror_mime_type : "text/x-python", filenames : ["BUCK", "BUILD", "BUILD.bazel",
    "MODULE.bazel", "Tiltfile", "WORKSPACE", "WORKSPACE.bazel", "WORKSPACE.bzlmod"],
    interpreters : [], }, Stata => { name : "Stata", r#type : "programming", color :
    "#1a5f91", extensions : [".do", ".ado", ".doh", ".ihlp", ".mata", ".matah",
    ".sthlp"], aliases : [], tm_scope : "source.stata", ace_mode : "text", language_id :
    358u64, filenames : [], interpreters : [], }, StringTemplate => { name :
    "StringTemplate", r#type : "markup", color : "#3fb34f", extensions : [".st"], aliases
    : [], tm_scope : "source.string-template", ace_mode : "html", language_id :
    89855901u64, codemirror_mode : "htmlmixed", codemirror_mime_type : "text/html",
    filenames : [], interpreters : [], }, Stylus => { name : "Stylus", r#type : "markup",
    color : "#ff6347", extensions : [".styl"], aliases : [], tm_scope : "source.stylus",
    ace_mode : "stylus", language_id : 359u64, codemirror_mode : "stylus",
    codemirror_mime_type : "text/x-styl", filenames : [], interpreters : [], },
    ...
    filenames : [], interpreters : ["sclang", "scsynth"], }, SurrealQL => { name :
    "SurrealQL", r#type : "programming", color : "#ff00a0", extensions : [".surql"],
    aliases : ["surql"], tm_scope : "source.surrealql", ace_mode : "text", language_id :
    735141027u64, filenames : [], interpreters : [], }, SurvexData => { name :
    ...
    ace_mode : "text", language_id : 364u64, filenames : [], interpreters : [], }, TMDL
    => { name : "TMDL", r#type : "data", color : "#f0c913", extensions : [".tmdl"],
    aliases : ["Tabular Model Definition Language"], tm_scope : "source.tmdl", ace_mode :
    "text", language_id : 769162295u64, filenames : [], interpreters : [], }, TOML => {
    ...
    interpreters : [], }, Tape => { name : "Tape", r#type : "programming", color :
    "#000000", extensions : [".tape"], aliases : ["vhs"], tm_scope : "source.vhs",
    ace_mode : "text", language_id : 516874200u64, filenames : [], interpreters : [], },
    Tcl => { name : "Tcl", r#type : "programming", color : "#e4cc98", extensions :
    [".tcl", ".adp", ".sdc", ".tcl.in", ".tm", ".xdc"], aliases : ["sdc", "xdc"],
    tm_scope : "source.tcl", ace_mode : "tcl", language_id : 367u64, codemirror_mode :
    "tcl", codemirror_mime_type : "text/x-tcl", filenames : ["owh", "starfield"],
    interpreters : ["tclsh", "wish"], }, Tcsh => { name : "Tcsh", r#type : "programming",
    color : "#000000", extensions : [".tcsh", ".csh"], aliases : [], tm_scope :
    "source.shell", ace_mode : "sh", language_id : 368u64, codemirror_mode : "shell",
    codemirror_mime_type : "text/x-sh", filenames : [], group : "Shell", interpreters :
    ["tcsh", "csh"], }, TeX => { name : "TeX", r#type : "markup", color : "#3D6117",
    extensions : [".tex", ".aux", ".bbx", ".cbx", ".cls", ".dtx", ".ins", ".lbx", ".ltx",
    ".mkii", ".mkiv", ".mkvi", ".sty", ".toc"], aliases : ["latex"], tm_scope :
    "text.tex.latex", ace_mode : "tex", language_id : 369u64, codemirror_mode : "stex",
    codemirror_mime_type : "text/x-stex", wrap : true, filenames : [], interpreters : [],
    }, Tea => { name : "Tea", r#type : "markup", color : "#000000", extensions :
    [".tea"], aliases : [], tm_scope : "source.tea", ace_mode : "text", language_id :
    370u64, filenames : [], interpreters : [], }, Teal => { name : "Teal", r#type :
    "programming", color : "#00B1BC", extensions : [".tl"], aliases : [], tm_scope :
    "source.teal", ace_mode : "lua", language_id : 719038619u64, codemirror_mode : "lua",
    codemirror_mime_type : "text/x-lua", filenames : [], interpreters : ["tl"], }, Terra
    => { name : "Terra", r#type : "programming", color : "#00004c", extensions : [".t"],
    aliases : [], tm_scope : "source.terra", ace_mode : "lua", language_id : 371u64,
    codemirror_mode : "lua", codemirror_mime_type : "text/x-lua", filenames : [],
    ...
    "LICENSE.mysql", "NEWS", "README.me", "README.mysql", "README.nss", "README.pc",
    "click.me", "delete.me", "keep.me", "package.mask", "package.use.mask",
    ...
    filenames : [], interpreters : [], }, Tolk => { name : "Tolk", r#type :
    "programming", color : "#30A1F5", extensions : [".tolk"], aliases : [], tm_scope :
    "source.tolk", ace_mode : "text", language_id : 678673060u64, codemirror_mode :
    "stylus", codemirror_mime_type : "text/x-styl", filenames : [], interpreters : [], },
    TorConfig => { name : "Tor Config", r#type : "data", color : "#59316b", extensions :
    [], aliases : ["torrc"], tm_scope : "source.torrc", ace_mode : "apache_conf",
    language_id : 1016912802u64, filenames : ["torrc"], interpreters : [], },
    TreeSitterQuery => { name : "Tree-sitter Query", r#type : "programming", color :
    "#8ea64c", extensions : [".scm"], aliases : ["tsq"], tm_scope : "source.scm",
    ace_mode : "text", language_id : 436081647u64, filenames : [], interpreters : [], },
    Turing => { name : "Turing", r#type : "programming", color : "#cf142b", extensions :
    [".t", ".tu"], aliases : [], tm_scope : "source.turing", ace_mode : "text",
    language_id : 375u64, filenames : [], interpreters : [], }, Turtle => { name :
    "Turtle", r#type : "data", color : "#000000", extensions : [".ttl"], aliases : [],
    tm_scope : "source.turtle", ace_mode : "turtle", language_id : 376u64,
    ...
    interpreters : ["bun", "deno", "ts-node", "tsx", "node"], }, TypeSpec => { name :
    "TypeSpec", r#type : "programming", color : "#4A3665", extensions : [".tsp"], aliases
    : ["tsp"], tm_scope : "source.tsp", ace_mode : "text", language_id : 952272597u64,
    filenames : [], interpreters : [], }, Typst => { name : "Typst", r#type :
    "programming", color : "#239dad", extensions : [".typ"], aliases : ["typ"], tm_scope
    : "source.typst", ace_mode : "text", language_id : 704730682u64, filenames : [],
    interpreters : [], }, UnifiedParallelC => { name : "Unified Parallel C", r#type :
    "programming", color : "#4e3617", extensions : [".upc"], aliases : [], tm_scope :
    "source.c", ace_mode : "c_cpp", language_id : 379u64, codemirror_mode : "clike",
    codemirror_mime_type : "text/x-csrc", filenames : [], group : "C", interpreters : [],
    }, Unity3DAsset => { name : "Unity3D Asset", r#type : "data", color : "#222c37",
    extensions : [".anim", ".asset", ".mask", ".mat", ".meta", ".prefab", ".unity"],
    aliases : [], tm_scope : "source.yaml", ace_mode : "yaml", language_id : 380u64,
    codemirror_mode : "yaml", codemirror_mime_type : "text/x-yaml", filenames : [],
    interpreters : [], }, UnixAssembly => { name : "Unix Assembly", r#type :
    "programming", color : "#000000", extensions : [".s", ".ms"], aliases : ["gas",
    "gnu asm", "unix asm"], tm_scope : "source.x86", ace_mode : "assembly_x86",
    language_id : 120u64, filenames : [], group : "Assembly", interpreters : [], }, Uno
    => { name : "Uno", r#type : "programming", color : "#9933cc", extensions : [".uno"],
    aliases : [], tm_scope : "source.cs", ace_mode : "csharp", language_id : 381u64,
    codemirror_mode : "clike", codemirror_mime_type : "text/x-csharp", filenames : [],
    interpreters : [], }, UnrealScript => { name : "UnrealScript", r#type :
    "programming", color : "#a54c4d", extensions : [".uc"], aliases : [], tm_scope :
    "source.java", ace_mode : "java", language_id : 382u64, codemirror_mode : "clike",
    codemirror_mime_type : "text/x-java", filenames : [], interpreters : [], },
    UntypedPlutusCore => { name : "Untyped Plutus Core", r#type : "programming", color :
    "#36adbd", extensions : [".uplc"], aliases : [], tm_scope : "source.uplc", ace_mode :
    "text", language_id : 1061635506u64, filenames : [], interpreters : [], }, UrWeb => {
    name : "UrWeb", r#type : "programming", color : "#ccccee", extensions : [".ur",
    ".urs"], aliases : ["Ur/Web", "Ur"], tm_scope : "source.ur", ace_mode : "text",
    language_id : 383u64, filenames : [], interpreters : [], }, V => { name : "V", r#type
    : "programming", color : "#4f87c4", extensions : [".v"], aliases : ["vlang"],
    tm_scope : "source.v", ace_mode : "golang", language_id : 603371597u64,
    codemirror_mode : "go", codemirror_mime_type : "text/x-go", filenames : [],
    interpreters : [], }, VBA => { name : "VBA", r#type : "programming", color :
    "#867db1", extensions : [".bas", ".cls", ".frm", ".vba"], aliases :
    ["visual basic for applications"], tm_scope : "source.vba", ace_mode : "text",
    language_id : 399230729u64, codemirror_mode : "vb", codemirror_mime_type :
    "text/x-vb", filenames : [], interpreters : [], }, VBScript => { name : "VBScript",
    r#type : "programming", color : "#15dcdc", extensions : [".vbs"], aliases : [],
    tm_scope : "source.vbnet", ace_mode : "vbscript", language_id : 408016005u64,
    codemirror_mode : "vbscript", codemirror_mime_type : "text/vbscript", filenames : [],
    interpreters : [], }, VCL => { name : "VCL", r#type : "programming", color :
    "#148AA8", extensions : [".vcl"], aliases : [], tm_scope : "source.vcl", ace_mode :
    "text", language_id : 384u64, filenames : [], interpreters : [], }, VHDL => { name :
    "VHDL", r#type : "programming", color : "#adb2cb", extensions : [".vhdl", ".vhd",
    ".vhf", ".vhi", ".vho", ".vhs", ".vht", ".vhw"], aliases : [], tm_scope :
    ...
    ".vmf"], aliases : ["keyvalues", "vdf"], tm_scope : "source.keyvalues", ace_mode :
    "text", language_id : 544060961u64, filenames : [], interpreters : [], },
    ...
    "text", language_id : 389u64, codemirror_mode : "vb", codemirror_mime_type :
    "text/x-vb", filenames : [], interpreters : [], }, VisualBasic60 => { name :
    "Visual Basic 6.0", r#type : "programming", color : "#2c6353", extensions : [".bas",
    ".cls", ".ctl", ".Dsr", ".frm"], aliases : ["vb6", "vb 6", "visual basic 6",
    "visual basic classic", "classic visual basic"], tm_scope : "source.vba", ace_mode :
    "text", language_id : 679594952u64, codemirror_mode : "vb", codemirror_mime_type :
    "text/x-vb", filenames : [], interpreters : [], }, Volt => { name : "Volt", r#type :
    "programming", color : "#1F1F1F", extensions : [".volt"], aliases : [], tm_scope :
    "source.d", ace_mode : "d", language_id : 390u64, codemirror_mode : "d",
    codemirror_mime_type : "text/x-d", filenames : [], interpreters : [], }, Vue => {
    name : "Vue", r#type : "markup", color : "#41b883", extensions : [".vue"], aliases :
    [], tm_scope : "text.html.vue", ace_mode : "vue", language_id : 391u64,
    codemirror_mode : "vue", codemirror_mime_type : "text/x-vue", filenames : [],
    interpreters : [], }, Vyper => { name : "Vyper", r#type : "programming", color :
    "#9F4CF2", extensions : [".vy"], aliases : [], tm_scope : "source.vyper", ace_mode :
    "text", language_id : 1055641948u64, filenames : [], interpreters : [], }, WDL => {
    name : "WDL", r#type : "programming", color : "#42f1f4", extensions : [".wdl"],
    aliases : ["Workflow Description Language"], tm_scope : "source.wdl", ace_mode :
    "text", language_id : 374521672u64, filenames : [], interpreters : [], }, WGSL => {
    name : "WGSL", r#type : "programming", color : "#1a5e9a", extensions : [".wgsl"],
    aliases : [], tm_scope : "source.wgsl", ace_mode : "text", language_id :
    836605993u64, filenames : [], interpreters : [], }, WavefrontMaterial => { name :
    ...
    956556503u64, codemirror_mode : "wast", codemirror_mime_type : "text/webassembly",
    filenames : [], interpreters : [], }, WebAssemblyInterfaceType => { name :
    "WebAssembly Interface Type", r#type : "data", color : "#6250e7", extensions :
    [".wit"], aliases : ["wit"], tm_scope : "source.wit", ace_mode : "text", language_id
    : 134534086u64, codemirror_mode : "webidl", codemirror_mime_type : "text/x-webidl",
    filenames : [], interpreters : [], }, WebIDL => { name : "WebIDL", r#type :
    "programming", color : "#000000", extensions : [".webidl"], aliases : [], tm_scope :
    "source.webidl", ace_mode : "text", language_id : 395u64, codemirror_mode : "webidl",
    codemirror_mime_type : "text/x-webidl", filenames : [], interpreters : [], }, WebVTT
    => { name : "WebVTT", r#type : "data", color : "#000000", extensions : [".vtt"],
    aliases : ["vtt"], tm_scope : "text.vtt", ace_mode : "text", language_id :
    ...
    ace_mode : "mediawiki", language_id : 228u64, wrap : true, filenames : [],
    interpreters : [], }, Win32MessageFile => { name : "Win32 Message File", r#type :
    "data", color : "#000000", extensions : [".mc"], aliases : [], tm_scope :
    "source.win32-messages", ace_mode : "ini", language_id : 950967261u64,
    codemirror_mode : "properties", codemirror_mime_type : "text/x-properties", filenames
    : [], interpreters : [], }, WindowsRegistryEntries => { name :
    "Windows Registry Entries", r#type : "data", color : "#52d5ff", extensions :
    ...
    "source.desktop", ace_mode : "text", language_id : 412u64, filenames : [], group :
    "INI", interpreters : [], }, Dircolors => { name : "dircolors", r#type : "data",
    color : "#000000", extensions : [".dircolors"], aliases : [], tm_scope :
    "source.dircolors", ace_mode : "text", language_id : 691605112u64, filenames :
    [".dir_colors", ".dircolors", "DIR_COLORS", "_dir_colors", "_dircolors",
    "dir_colors"], interpreters : [], }, EC => { name : "eC", r#type : "programming",
    color : "#913960", extensions : [".ec", ".eh"], aliases : [], tm_scope :
    "source.c.ec", ace_mode : "text", language_id : 413u64, filenames : [], interpreters
    : [], }, Edn => { name : "edn", r#type : "data", color : "#000000", extensions :
    [".edn"], aliases : [], tm_scope : "source.clojure", ace_mode : "clojure",
    language_id : 414u64, codemirror_mode : "clojure", codemirror_mime_type :
    "application/edn", filenames : [], interpreters : [], }, Fish => { name : "fish",
    r#type : "programming", color : "#4aae47", extensions : [".fish"], aliases : [],
    tm_scope : "source.fish", ace_mode : "text", language_id : 415u64, filenames : [],
    group : "Shell", interpreters : ["fish"], }, Hoon => { name : "hoon", r#type :
    "programming", color : "#00b171", extensions : [".hoon"], aliases : [], tm_scope :
    "source.hoon", ace_mode : "text", language_id : 560883276u64, filenames : [],
    interpreters : [], }, ICalendar => { name : "iCalendar", r#type : "data", color :
    "#ec564c", extensions : [".ics", ".ical"], aliases : ["iCal"], tm_scope :
    "source.iCalendar", ace_mode : "properties", language_id : 98384424u64,
    codemirror_mode : "properties", codemirror_mime_type : "text/x-properties", filenames
    ...
    [], }, PkgConfig => { name : "pkg-config", r#type : "data", color : "#2b5e82",
    extensions : [".pc", ".pc.in"], aliases : ["pkgconf"], tm_scope : "source.pkgconf",
    ace_mode : "properties", language_id : 925023573u64, codemirror_mode : "properties",
    codemirror_mime_type : "text/x-properties", filenames : [], interpreters : [], }, Q
    => { name : "q", r#type : "programming", color : "#0040cd", extensions : [".q"],
    aliases : [], tm_scope : "source.q", ace_mode : "text", language_id : 970539067u64,
    codemirror_mode : "q", codemirror_mime_type : "text/x-q", filenames : [],
    ...
    filenames : [], interpreters : [], }, Sed => { name : "sed", r#type : "programming",
    color : "#64b970", extensions : [".sed"], aliases : [], tm_scope : "source.sed",
    ace_mode : "text", language_id : 847830017u64, filenames : [], interpreters :
    ["gsed", "minised", "sed", "ssed"], }, Templ => { name : "templ", r#type : "markup",
    color : "#66D0DD", extensions : [".templ"], aliases : [], tm_scope : "source.templ",
    ace_mode : "text", language_id : 795579337u64, filenames : [], interpreters : [], },
    Ucode => { name : "ucode", r#type : "programming", color : "#00b8d4", extensions :
    [".uc"], aliases : [], tm_scope : "source.ucode", ace_mode : "javascript",
    language_id : 365454253u64, codemirror_mode : "javascript", codemirror_mime_type :
    "text/javascript", filenames : [], interpreters : ["ucode"], }, VCard => { name :
    "vCard", r#type : "data", color : "#ee2647", extensions : [".vcf"], aliases :
...
static BY_EXTENSION: phf::Map<&'static str, &'static [fn() -> LanguageInfo]> = phf_map! {
    ...
    [Agda::info], ".ah1" => & [AutoHotkey::info], ".ah2" => & [AutoHotkey::info], ".ahk"
    => & [AutoHotkey::info], ".ahkl" => & [AutoHotkey::info], ".aidl" => & [AIDL::info],
    ".aj" => & [AspectJ::info], ".ak" => & [Aiken::info], ".al" => & [AL::info,
    Perl::info], ".aleo" => & [Aleo::info], ".alg" => & [ALGOL::info], ".als" => &
    [Alloy::info], ".ampl" => & [AMPL::info], ".angelscript" => & [AngelScript::info],
    ".anim" => & [Unity3DAsset::info], ".ant" => & [XML::info], ".antlers.html" => &
    [Antlers::info], ".antlers.php" => & [Antlers::info], ".antlers.xml" => &
    [Antlers::info], ".apacheconf" => & [ApacheConf::info], ".apex" => & [Apex::info],
    ".apib" => & [APIBlueprint::info], ".apl" => & [APL::info], ".app" => &
    ...
    KoLmafiaASH::info], ".ashx" => & [ASPNET::info], ".asl" => & [ASL::info], ".asm" => &
    [Assembly::info, Motorola68KAssembly::info], ".asmx" => & [ASPNET::info], ".asn" => &
    [ASN1::info], ".asn1" => & [ASN1::info], ".asp" => & [ClassicASP::info], ".aspx" => &
    ...
    [Brainfuck::info, Limbo::info], ".bal" => & [Ballerina::info], ".baml" => &
    [BAML::info], ".bas" => & [B4X::info, BASIC::info, FreeBASIC::info, QuickBASIC::info,
    VBA::info, VisualBasic60::info], ".bash" => & [Shell::info], ".bat" => &
    [Batchfile::info], ".bats" => & [Shell::info], ".bb" => & [BitBake::info,
    ...
    ".cairo" => & [Cairo::info, CairoZero::info], ".cake" => & [Csharp::info,
    CoffeeScript::info], ".capnp" => & [CapnProto::info], ".carbon" => & [Carbon::info],
    ".cats" => & [C::info], ".cbl" => & [COBOL::info], ".cbx" => & [TeX::info], ".cc" =>
    & [Cpp::info], ".ccp" => & [COBOL::info], ".ccproj" => & [XML::info], ".ccxml" => &
    [XML::info], ".cdc" => & [Cadence::info], ".cdf" => & [WolframLanguage::info], ".cds"
    => & [CAPCDS::info], ".ceylon" => & [Ceylon::info], ".cfc" => &
    [ColdFusionCFC::info], ".cfg" => & [HAProxy::info, INI::info], ".cfm" => &
    ...
    [HTTP::info], ".hujson" => & [JSONWithComments::info], ".hurl" => & [Hurl::info],
    ...
    [JASS::info, Jasmin::info, ObjectiveJ::info], ".j2" => & [Jinja::info], ".jac" => &
    [Jac::info], ".jade" => & [Pug::info], ".jai" => & [Jai::info], ".jake" => &
    [JavaScript::info], ".janet" => & [Janet::info], ".jav" => & [Java::info], ".java" =>
    & [Java::info], ".javascript" => & [JavaScript::info], ".jbuilder" => & [Ruby::info],
    ".jcl" => & [JCL::info], ".jelly" => & [XML::info], ".jflex" => & [JFlex::info],
    ".jinja" => & [Jinja::info], ".jinja2" => & [Jinja::info], ".jison" => &
    ...
    [LookML::info], ".ll" => & [LLVM::info], ".lmi" => & [Python::info], ".lobster" => &
    [Lobster::info], ".logtalk" => & [Logtalk::info], ".lol" => & [LOLCODE::info],
    ".lookml" => & [LookML::info], ".lp" => & [AnswerSetProgramming::info,
    Lambdapi::info, LinearProgramming::info], ".lpr" => & [Pascal::info], ".ls" => &
    [LiveScript::info, LoomScript::info], ".lsl" => & [LSL::info], ".lslp" => &
    [LSL::info], ".lsp" => & [CommonLisp::info, NewLisp::info], ".ltx" => & [TeX::info],
    ".lua" => & [Lua::info], ".luau" => & [Luau::info], ".lvclass" => & [LabVIEW::info],
    ".lvlib" => & [LabVIEW::info], ".lvproj" => & [LabVIEW::info], ".ly" => &
    ...
    ".mcfunction" => & [Mcfunction::info], ".mch" => & [BFormalMethod::info], ".mcmeta"
    => & [JSON::info], ".mcr" => & [MAXScript::info], ".md" => &
    [GCCMachineDescription::info, Markdown::info], ".md2" => & [Checksums::info], ".md4"
    => & [Checksums::info], ".md5" => & [Checksums::info], ".mdoc" => & [Roff::info,
    ...
    [NEON::info], ".network" => & [INI::info], ".nf" => & [Nextflow::info], ".nginx" => &
    [Nginx::info], ".nginxconf" => & [Nginx::info], ".ni" => & [Inform7::info], ".nim" =>
    & [Nim::info], ".nim.cfg" => & [Nim::info], ".nimble" => & [Nim::info], ".nimrod" =>
    & [Nim::info], ".nims" => & [Nim::info], ".ninja" => & [Ninja::info], ".nit" => &
    [Nit::info], ".nix" => & [Nix::info], ".njk" => & [Nunjucks::info], ".njs" => &
    [JavaScript::info], ".nl" => & [NL::info, NewLisp::info], ".nlogo" => &
    [NetLogo::info], ".no" => & [Text::info], ".nomad" => & [HCL::info], ".nproj" => &
    [XML::info], ".nqp" => & [Raku::info], ".nr" => & [Noir::info, Roff::info], ".nse" =>
    & [Lua::info], ".nsh" => & [NSIS::info], ".nsi" => & [NSIS::info], ".nss" => &
    [NWScript::info], ".nu" => & [Nu::info, Nushell::info], ".numpy" => & [NumPy::info],
    ".numpyw" => & [NumPy::info], ".numsc" => & [NumPy::info], ".nuspec" => &
    [XML::info], ".nut" => & [Squirrel::info], ".ny" => & [CommonLisp::info], ".ob2" => &
    [Oberon::info], ".obj" => & [WavefrontObject::info], ".objdump" => & [ObjDump::info],
    ".odd" => & [XML::info], ".odin" => & [ObjectDataInstanceNotation::info, Odin::info],
    ".ol" => & [Jolie::info], ".omgrofl" => & [Omgrofl::info], ".ooc" => & [Ooc::info],
    ".opa" => & [Opa::info], ".opal" => & [Opal::info], ".opencl" => & [OpenCL::info],
    ".opy" => & [OverPy::info], ".orc" => & [Csound::info], ".org" => & [Org::info],
    ".os" => & [_1CEnterprise::info], ".osm" => & [XML::info], ".overpassql" => &
    [OverpassQL::info], ".owl" => & [WebOntologyLanguage::info], ".ox" => & [Ox::info],
    ".oxh" => & [Ox::info], ".oxo" => & [Ox::info], ".oxygene" => & [Oxygene::info],
    ".oz" => & [Oz::info], ".p" => & [Gnuplot::info, OpenEdgeABL::info], ".p4" => &
    [P4::info], ".p6" => & [Raku::info], ".p6l" => & [Raku::info], ".p6m" => &
    [Raku::info], ".p8" => & [Lua::info], ".pac" => & [JavaScript::info], ".pacscript" =>
    & [Shell::info], ".pact" => & [Pact::info], ".pan" => & [Pan::info], ".parrot" => &
    [Parrot::info], ".pas" => & [Pascal::info], ".pascal" => & [Pascal::info], ".pasm" =>
    & [ParrotAssembly::info], ".pat" => & [Max::info], ".patch" => & [Diff::info], ".pb"
    => & [PureBasic::info], ".pbi" => & [PureBasic::info], ".pbt" => &
    [PowerBuilder::info, ProtocolBufferTextFormat::info], ".pbtxt" => &
    [ProtocolBufferTextFormat::info], ".pc" => & [ProstarC::info, PkgConfig::info],
    ".pc.in" => & [PkgConfig::info], ".pck" => & [PLSQL::info], ".pcss" => &
    ...
    [REXX::info], ".pq" => & [PowerQuery::info], ".praat" => & [Praat::info], ".prawn" =>
    & [Ruby::info], ".prc" => & [PLSQL::info, SQL::info], ".prefab" => &
    [Unity3DAsset::info], ".prefs" => & [INI::info], ".prg" => & [XBase::info], ".pri" =>
    & [QMake::info], ".prisma" => & [Prisma::info], ".pro" => & [IDL::info, INI::info,
    Proguard::info, Prolog::info, QMake::info], ".proj" => & [XML::info], ".prolog" => &
    [Prolog::info], ".properties" => & [INI::info, JavaProperties::info], ".props" => &
    [XML::info], ".proto" => & [ProtocolBuffer::info], ".prw" => & [XBase::info], ".ps"
    => & [PostScript::info], ".ps1" => & [PowerShell::info], ".ps1xml" => & [XML::info],
    ".psc" => & [Papyrus::info], ".psc1" => & [XML::info], ".psd1" => &
    [PowerShell::info], ".psgi" => & [Perl::info], ".psm1" => & [PowerShell::info], ".pt"
    => & [XML::info], ".pub" => & [PublicKey::info], ".pubxml" => & [XML::info], ".pug"
    => & [Pug::info], ".puml" => & [PlantUML::info], ".purs" => & [PureScript::info],
    ".pwn" => & [Pawn::info], ".pxd" => & [Cython::info], ".pxi" => & [Cython::info],
    ".py" => & [Python::info], ".py3" => & [Python::info], ".pyde" => & [Python::info],
    ".pyi" => & [Python::info], ".pyp" => & [Python::info], ".pyt" => & [Python::info],
    ".pytb" => & [PythonTraceback::info], ".pyw" => & [Python::info], ".pyx" => &
    [Cython::info], ".q" => & [HiveQL::info, Q::info], ".qasm" => & [OpenQASM::info],
    ".qbs" => & [QML::info], ".qc" => & [QuakeC::info], ".qhelp" => & [XML::info], ".ql"
    => & [CodeQL::info], ".qll" => & [CodeQL::info], ".qmd" => & [RMarkdown::info],
    ".qml" => & [QML::info], ".qnt" => & [Quint::info], ".qs" => & [Qsharp::info,
    ...
    [RAML::info], ".rascript" => & [RAScript::info], ".raw" => & [RawTokenData::info],
    ".razor" => & [HTMLpRazor::info], ".rb" => & [Ruby::info], ".rbbas" => &
    [REALbasic::info], ".rbfrm" => & [REALbasic::info], ".rbi" => & [Ruby::info],
    ".rbmnu" => & [REALbasic::info], ".rbres" => & [REALbasic::info], ".rbs" => &
    [RBS::info], ".rbtbar" => & [REALbasic::info], ".rbuild" => & [Ruby::info],
    ".rbuistate" => & [REALbasic::info], ".rbw" => & [Ruby::info], ".rbx" => &
    [Ruby::info], ".rbxmx" => & [XML::info], ".rbxs" => & [Lua::info], ".rchit" => &
    [GLSL::info], ".rd" => & [R::info], ".rdf" => & [XML::info], ".rdoc" => &
    [RDoc::info], ".re" => & [Cpp::info, Reason::info], ".reb" => & [Rebol::info],
    ".rebol" => & [Rebol::info], ".red" => & [Red::info], ".reds" => & [Red::info,
    Redscript::info], ".reek" => & [YAML::info], ".reg" => &
    ...
    Mdsvex::info], ".sw" => & [Sway::info, XML::info], ".swg" => & [SWIG::info], ".swift"
    => & [Swift::info], ".swig" => & [SWIG::info], ".syntax" => & [YAML::info], ".t" => &
    [Perl::info, Raku::info, Terra::info, Turing::info], ".tab" => & [SQL::info], ".tac"
    ...
    ".tml" => & [XML::info], ".tmpl" => & [GoTemplate::info], ".tmux" => & [Shell::info],
    ".toc" => & [TeX::info, WorldOfWarcraftAddonData::info], ".tofu" => & [HCL::info],
    ".toit" => & [Toit::info], ".tolk" => & [Tolk::info], ".toml" => & [TOML::info],
    ".toml.example" => & [TOML::info], ".tool" => & [Shell::info], ".topojson" => &
    [JSON::info], ".tpb" => & [PLSQL::info], ".tpl" => & [GoTemplate::info,
    Smarty::info], ".tpp" => & [Cpp::info], ".tps" => & [PLSQL::info], ".tres" => &
    [GodotResource::info], ".trg" => & [PLSQL::info], ".trigger" => & [Apex::info,
    Shell::info], ".ts" => & [TypeScript::info, XML::info], ".tscn" => &
    [GodotResource::info], ".tsconfig.json" => & [JSONWithComments::info], ".tsp" => &
    [TSPLIBData::info, TypeSpec::info], ".tst" => & [GAP::info, Scilab::info], ".tsv" =>
    ...
    Ucode::info], ".udf" => & [SQL::info], ".udo" => & [Csound::info], ".ui" => &
    [XML::info], ".unity" => & [Unity3DAsset::info], ".uno" => & [Uno::info], ".upc" => &
    ...
    => & [Verilog::info], ".verse" => & [Verse::info], ".vert" => & [GLSL::info], ".vh"
    => & [SystemVerilog::info], ".vhd" => & [VHDL::info], ".vhdl" => & [VHDL::info],
    ".vhf" => & [VHDL::info], ".vhi" => & [VHDL::info], ".vho" => & [VHDL::info],
    ".vhost" => & [ApacheConf::info, Nginx::info], ".vhs" => & [VHDL::info], ".vht" => &
    [VHDL::info], ".vhw" => & [VHDL::info], ".vim" => & [VimScript::info], ".vimrc" => &
    [VimScript::info], ".viw" => & [SQL::info], ".vmb" => & [VimScript::info], ".vmf" =>
    & [ValveDataFormat::info], ".volt" => & [Volt::info], ".vrx" => & [GLSL::info], ".vs"
