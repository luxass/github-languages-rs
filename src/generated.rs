...
define_languages! {
    ...
    extensions : [".applescript", ".scpt"], aliases : ["apples", "osascript"], tm_scope :
    ...
    extensions : [".ahk", ".ahkl"], aliases : ["ahk"], tm_scope : "source.ahk", ace_mode
    : "autohotkey", language_id : 26u64, filenames : [], interpreters : [], }, AutoIt =>
    { name : "AutoIt", r#type : "programming", color : "#1C3552", extensions : [".au3"],
    aliases : ["au3", "AutoIt3", "AutoItScript"], tm_scope : "source.autoit", ace_mode :
    ...
    28u64, filenames : [], interpreters : ["awk", "gawk", "mawk", "nawk"], },
    BFormalMethod => { name : "B (Formal Method)", r#type : "programming", color :
    "#8aa8c5", extensions : [".mch"], aliases : [], tm_scope : "source.b", ace_mode :
    "text", language_id : 700792152u64, filenames : [], interpreters : [], }, B4X => {
    ...
    ".ksh", ".sbatch", ".sh.in", ".slurm", ".tmux", ".tool", ".trigger", ".zsh",
    ".zsh-theme"], aliases : ["sh", "shell-script", "bash", "zsh", "envrc"], tm_scope :
    "source.shell", ace_mode : "sh", language_id : 346u64, codemirror_mode : "shell",
    codemirror_mime_type : "text/x-sh", filenames : [".bash_aliases", ".bash_functions",
    ".bash_history", ".bash_logout", ".bash_profile", ".bashrc", ".cshrc", ".envrc",
    ".flaskenv", ".kshrc", ".login", ".profile", ".tmux.conf", ".xinitrc", ".xsession",
    ".zlogin", ".zlogout", ".zprofile", ".zshenv", ".zshrc", "9fs", "PKGBUILD",
    "bash_aliases", "bash_logout", "bash_profile", "bashrc", "cshrc", "gradlew", "kshrc",
    "login", "man", "mvnw", "profile", "tmux.conf", "xinitrc", "xsession", "zlogin",
    "zlogout", "zprofile", "zshenv", "zshrc"], interpreters : ["ash", "bash", "dash",
    "ksh", "mksh", "pdksh", "rc", "sh", "zsh"], }, ShellCheckConfig => { name :
    "ShellCheck Config", r#type : "data", color : "#cecfcb", extensions : [], aliases :
    ["shellcheckrc"], tm_scope : "source.shellcheckrc", ace_mode : "ini", language_id :
    687511714u64, codemirror_mode : "properties", codemirror_mime_type :
    "text/x-properties", filenames : [".shellcheckrc"], interpreters : [], },
    ShellSession => { name : "ShellSession", r#type : "programming", color : "#000000",
    extensions : [".sh-session"], aliases : ["bash session", "console"], tm_scope :
    "text.shell-session", ace_mode : "sh", language_id : 347u64, codemirror_mode :
    "shell", codemirror_mime_type : "text/x-sh", filenames : [], interpreters : [], },
    Shen => { name : "Shen", r#type : "programming", color : "#120F14", extensions :
    [".shen"], aliases : [], tm_scope : "source.shen", ace_mode : "text", language_id :
    348u64, filenames : [], interpreters : [], }, Sieve => { name : "Sieve", r#type :
    "programming", color : "#000000", extensions : [".sieve"], aliases : [], tm_scope :
    "source.sieve", ace_mode : "text", language_id : 208976687u64, codemirror_mode :
    "sieve", codemirror_mime_type : "application/sieve", filenames : [], interpreters :
    [], }, SimpleFileVerification => { name : "Simple File Verification", r#type :
    "data", color : "#C9BFED", extensions : [".sfv"], aliases : ["sfv"], tm_scope :
    "source.sfv", ace_mode : "ini", language_id : 735623761u64, codemirror_mode :
    "properties", codemirror_mime_type : "text/x-properties", filenames : [], group :
    "Checksums", interpreters : [], }, Singularity => { name : "Singularity", r#type :
    "programming", color : "#64E6AD", extensions : [], aliases : [], tm_scope :
    "source.singularity", ace_mode : "text", language_id : 987024632u64, filenames :
    ["Singularity"], interpreters : [], }, Slang => { name : "Slang", r#type :
    "programming", color : "#1fbec9", extensions : [".slang"], aliases : [], tm_scope :
    "source.slang", ace_mode : "text", language_id : 239357863u64, filenames : [],
    interpreters : [], }, Slash => { name : "Slash", r#type : "programming", color :
    "#007eff", extensions : [".sl"], aliases : [], tm_scope : "text.html.slash", ace_mode
    : "text", language_id : 349u64, filenames : [], interpreters : [], }, Slice => { name
    : "Slice", r#type : "programming", color : "#003fa2", extensions : [".ice"], aliases
    : [], tm_scope : "source.ice", ace_mode : "text", language_id : 894641667u64,
    filenames : [], interpreters : [], }, Slim => { name : "Slim", r#type : "markup",
    color : "#2b2b2b", extensions : [".slim"], aliases : [], tm_scope : "text.slim",
    ace_mode : "slim", language_id : 350u64, codemirror_mode : "slim",
    codemirror_mime_type : "text/x-slim", filenames : [], interpreters : [], }, Slint =>
    { name : "Slint", r#type : "markup", color : "#2379F4", extensions : [".slint"],
    aliases : [], tm_scope : "source.slint", ace_mode : "text", language_id :
    119900149u64, filenames : [], interpreters : [], }, SmPL => { name : "SmPL", r#type :
    "programming", color : "#c94949", extensions : [".cocci"], aliases : ["coccinelle"],
    tm_scope : "source.smpl", ace_mode : "text", language_id : 164123055u64, filenames :
    [], interpreters : [], }, Smali => { name : "Smali", r#type : "programming", color :
    "#000000", extensions : [".smali"], aliases : [], tm_scope : "source.smali", ace_mode
    : "text", language_id : 351u64, filenames : [], interpreters : [], }, Smalltalk => {
    name : "Smalltalk", r#type : "programming", color : "#596706", extensions : [".st",
    ".cs"], aliases : ["squeak"], tm_scope : "source.smalltalk", ace_mode : "text",
    language_id : 352u64, codemirror_mode : "smalltalk", codemirror_mime_type :
    "text/x-stsrc", filenames : [], interpreters : [], }, Smarty => { name : "Smarty",
    r#type : "programming", color : "#f0c040", extensions : [".tpl"], aliases : [],
    tm_scope : "text.html.smarty", ace_mode : "smarty", language_id : 353u64,
    codemirror_mode : "smarty", codemirror_mime_type : "text/x-smarty", filenames : [],
    interpreters : [], }, Smithy => { name : "Smithy", r#type : "programming", color :
    "#c44536", extensions : [".smithy"], aliases : [], tm_scope : "source.smithy",
    ace_mode : "smithy", language_id : 1027892786u64, codemirror_mode : "clike",
    codemirror_mime_type : "text/x-csrc", filenames : [], interpreters : [], }, Snakemake
    => { name : "Snakemake", r#type : "programming", color : "#419179", extensions :
    [".smk", ".snakefile"], aliases : ["snakefile"], tm_scope : "source.python", ace_mode
    : "python", language_id : 151241392u64, codemirror_mode : "python",
    codemirror_mime_type : "text/x-python", filenames : ["Snakefile"], group : "Python",
    interpreters : [], }, Solidity => { name : "Solidity", r#type : "programming", color
    : "#AA6746", extensions : [".sol"], aliases : [], tm_scope : "source.solidity",
    ace_mode : "text", language_id : 237469032u64, filenames : [], interpreters : [], },
    Soong => { name : "Soong", r#type : "data", color : "#000000", extensions : [],
    aliases : [], tm_scope : "source.bp", ace_mode : "text", language_id : 222900098u64,
    ...
    ".sml"], aliases : ["sml"], tm_scope : "source.ml", ace_mode : "text", language_id :
    357u64, codemirror_mode : "mllike", codemirror_mime_type : "text/x-sml", filenames :
    [], interpreters : [], }, Starlark => { name : "Starlark", r#type : "programming",
    color : "#76d275", extensions : [".bzl", ".star"], aliases : ["bazel", "bzl"],
    tm_scope : "source.python", ace_mode : "python", language_id : 960266174u64,
    codemirror_mode : "python", codemirror_mime_type : "text/x-python", filenames :
    ["BUCK", "BUILD", "BUILD.bazel", "MODULE.bazel", "Tiltfile", "WORKSPACE",
    "WORKSPACE.bazel", "WORKSPACE.bzlmod"], interpreters : [], }, Stata => { name :
    "Stata", r#type : "programming", color : "#1a5f91", extensions : [".do", ".ado",
    ".doh", ".ihlp", ".mata", ".matah", ".sthlp"], aliases : [], tm_scope :
    "source.stata", ace_mode : "text", language_id : 358u64, filenames : [], interpreters
    : [], }, StringTemplate => { name : "StringTemplate", r#type : "markup", color :
    "#3fb34f", extensions : [".st"], aliases : [], tm_scope : "source.string-template",
    ace_mode : "html", language_id : 89855901u64, codemirror_mode : "htmlmixed",
    codemirror_mime_type : "text/html", filenames : [], interpreters : [], }, Stylus => {
    name : "Stylus", r#type : "markup", color : "#ff6347", extensions : [".styl"],
    aliases : [], tm_scope : "source.stylus", ace_mode : "stylus", language_id : 359u64,
    codemirror_mode : "stylus", codemirror_mime_type : "text/x-styl", filenames : [],
    ...
    SurrealQL => { name : "SurrealQL", r#type : "programming", color : "#ff00a0",
    extensions : [".surql"], aliases : ["surql"], tm_scope : "source.surrealql", ace_mode
    : "text", language_id : 735141027u64, filenames : [], interpreters : [], },
    ...
    "README.nss", "README.pc", "click.me", "delete.me", "keep.me", "package.mask",
    "package.use.mask", "package.use.stable.mask", "read.me", "readme.1st", "test.me",
    "use.mask", "use.stable.mask"], interpreters : [], }, TextGrid => { name :
    "TextGrid", r#type : "data", color : "#c8506d", extensions : [".TextGrid"], aliases :
    [], tm_scope : "source.textgrid", ace_mode : "text", language_id : 965696054u64,
    filenames : [], interpreters : [], }, TextMateProperties => { name :
    "TextMate Properties", r#type : "data", color : "#df66e4", extensions : [], aliases :
    ["tm-properties"], tm_scope : "source.tm-properties", ace_mode : "properties",
    language_id : 981795023u64, codemirror_mode : "properties", codemirror_mime_type :
    "text/x-properties", filenames : [".tm_properties"], interpreters : [], }, Textile =>
    { name : "Textile", r#type : "prose", color : "#ffe7ac", extensions : [".textile"],
    aliases : [], tm_scope : "none", ace_mode : "textile", language_id : 373u64,
    codemirror_mode : "textile", codemirror_mime_type : "text/x-textile", wrap : true,
    filenames : [], interpreters : [], }, Thrift => { name : "Thrift", r#type :
    "programming", color : "#D12127", extensions : [".thrift"], aliases : [], tm_scope :
    "source.thrift", ace_mode : "text", language_id : 374u64, filenames : [],
    interpreters : [], }, Toit => { name : "Toit", r#type : "programming", color :
    "#c2c9fb", extensions : [".toit"], aliases : [], tm_scope : "source.toit", ace_mode :
    "text", language_id : 356554395u64, filenames : [], interpreters : [], }, TorConfig
    => { name : "Tor Config", r#type : "data", color : "#59316b", extensions : [],
    aliases : ["torrc"], tm_scope : "source.torrc", ace_mode : "apache_conf", language_id
    : 1016912802u64, filenames : ["torrc"], interpreters : [], }, TreeSitterQuery => {
    name : "Tree-sitter Query", r#type : "programming", color : "#8ea64c", extensions :
    [".scm"], aliases : ["tsq"], tm_scope : "source.scm", ace_mode : "text", language_id
    : 436081647u64, filenames : [], interpreters : [], }, Turing => { name : "Turing",
    r#type : "programming", color : "#cf142b", extensions : [".t", ".tu"], aliases : [],
    tm_scope : "source.turing", ace_mode : "text", language_id : 375u64, filenames : [],
    interpreters : [], }, Turtle => { name : "Turtle", r#type : "data", color :
    "#000000", extensions : [".ttl"], aliases : [], tm_scope : "source.turtle", ace_mode
    : "turtle", language_id : 376u64, codemirror_mode : "turtle", codemirror_mime_type :
    "text/turtle", filenames : [], interpreters : [], }, Twig => { name : "Twig", r#type
    : "markup", color : "#c1d026", extensions : [".twig"], aliases : [], tm_scope :
    "text.html.twig", ace_mode : "twig", language_id : 377u64, codemirror_mode : "twig",
    codemirror_mime_type : "text/x-twig", filenames : [], interpreters : [], },
    TypeLanguage => { name : "Type Language", r#type : "data", color : "#000000",
    extensions : [".tl"], aliases : ["tl"], tm_scope : "source.tl", ace_mode : "text",
    language_id : 632765617u64, filenames : [], interpreters : [], }, TypeScript => {
    name : "TypeScript", r#type : "programming", color : "#3178c6", extensions : [".ts",
    ".cts", ".mts"], aliases : ["ts"], tm_scope : "source.ts", ace_mode : "typescript",
    language_id : 378u64, codemirror_mode : "javascript", codemirror_mime_type :
    "application/typescript", filenames : [], interpreters : ["bun", "deno", "ts-node",
    "tsx"], }, TypeSpec => { name : "TypeSpec", r#type : "programming", color :
    "#4A3665", extensions : [".tsp"], aliases : ["tsp"], tm_scope : "source.tsp",
    ace_mode : "text", language_id : 952272597u64, filenames : [], interpreters : [], },
    Typst => { name : "Typst", r#type : "programming", color : "#239dad", extensions :
    [".typ"], aliases : ["typ"], tm_scope : "source.typst", ace_mode : "text",
    language_id : 704730682u64, filenames : [], interpreters : [], }, UnifiedParallelC =>
    { name : "Unified Parallel C", r#type : "programming", color : "#4e3617", extensions
    : [".upc"], aliases : [], tm_scope : "source.c", ace_mode : "c_cpp", language_id :
    379u64, codemirror_mode : "clike", codemirror_mime_type : "text/x-csrc", filenames :
    [], group : "C", interpreters : [], }, Unity3DAsset => { name : "Unity3D Asset",
    r#type : "data", color : "#222c37", extensions : [".anim", ".asset", ".mask", ".mat",
    ".meta", ".prefab", ".unity"], aliases : [], tm_scope : "source.yaml", ace_mode :
    "yaml", language_id : 380u64, codemirror_mode : "yaml", codemirror_mime_type :
    "text/x-yaml", filenames : [], interpreters : [], }, UnixAssembly => { name :
    "Unix Assembly", r#type : "programming", color : "#000000", extensions : [".s",
    ".ms"], aliases : ["gas", "gnu asm", "unix asm"], tm_scope : "source.x86", ace_mode :
    "assembly_x86", language_id : 120u64, filenames : [], group : "Assembly",
    interpreters : [], }, Uno => { name : "Uno", r#type : "programming", color :
    "#9933cc", extensions : [".uno"], aliases : [], tm_scope : "source.cs", ace_mode :
    "csharp", language_id : 381u64, codemirror_mode : "clike", codemirror_mime_type :
    "text/x-csharp", filenames : [], interpreters : [], }, UnrealScript => { name :
    "UnrealScript", r#type : "programming", color : "#a54c4d", extensions : [".uc"],
    aliases : [], tm_scope : "source.java", ace_mode : "java", language_id : 382u64,
    codemirror_mode : "clike", codemirror_mime_type : "text/x-java", filenames : [],
    interpreters : [], }, UntypedPlutusCore => { name : "Untyped Plutus Core", r#type :
    "programming", color : "#36adbd", extensions : [".uplc"], aliases : [], tm_scope :
    "source.uplc", ace_mode : "text", language_id : 1061635506u64, filenames : [],
    interpreters : [], }, UrWeb => { name : "UrWeb", r#type : "programming", color :
    "#ccccee", extensions : [".ur", ".urs"], aliases : ["Ur/Web", "Ur"], tm_scope :
    "source.ur", ace_mode : "text", language_id : 383u64, filenames : [], interpreters :
    [], }, V => { name : "V", r#type : "programming", color : "#4f87c4", extensions :
    [".v"], aliases : ["vlang"], tm_scope : "source.v", ace_mode : "golang", language_id
    : 603371597u64, codemirror_mode : "go", codemirror_mime_type : "text/x-go", filenames
    ...
    extensions : [".vue"], aliases : [], tm_scope : "text.html.vue", ace_mode : "vue",
    ...
    VCard => { name : "vCard", r#type : "data", color : "#ee2647", extensions : [".vcf"],
    aliases : ["virtual contact file", "electronic business card"], tm_scope :
    "source.vcard", ace_mode : "properties", language_id : 851476558u64, codemirror_mode
    : "properties", codemirror_mime_type : "text/x-properties", filenames : [],
    interpreters : [], }, Wisp => { name : "wisp", r#type : "programming", color :
    "#7582D1", extensions : [".wisp"], aliases : [], tm_scope : "source.clojure",
    ace_mode : "clojure", language_id : 420u64, codemirror_mode : "clojure",
    codemirror_mime_type : "text/x-clojure", filenames : [], interpreters : [], }, XBase
    => { name : "xBase", r#type : "programming", color : "#403a40", extensions : [".prg",
    ".ch", ".prw"], aliases : ["advpl", "clipper", "foxpro"], tm_scope :
    "source.harbour", ace_mode : "text", language_id : 421u64, filenames : [],
    interpreters : [], },
}
static BY_EXTENSION: phf::Map<&'static str, &'static [fn() -> LanguageInfo]> = phf_map! {
    ...
    ".al" => & [AL::info, Perl::info], ".alg" => & [ALGOL::info], ".als" => &
    ...
    ".lvclass" => & [LabVIEW::info], ".lvlib" => & [LabVIEW::info], ".lvproj" => &
    [LabVIEW::info], ".ly" => & [LilyPond::info], ".m" => & [Limbo::info, M::info,
    MATLAB::info, MUF::info, Mercury::info, ObjectiveC::info, WolframLanguage::info],
    ".m2" => & [Macaulay2::info], ".m3" => & [Modula3::info], ".m3u" => & [M3U::info],
    ".m3u8" => & [M3U::info], ".m4" => & [M4::info, M4Sugar::info], ".ma" => &
    ...
    [MIRCScript::info], ".ms" => & [MAXScript::info, Roff::info, UnixAssembly::info],
    ...
    [Raku::info], ".p8" => & [Lua::info], ".pac" => & [JavaScript::info], ".pact" => &
    [Pact::info], ".pan" => & [Pan::info], ".parrot" => & [Parrot::info], ".pas" => &
    [Pascal::info], ".pascal" => & [Pascal::info], ".pasm" => & [ParrotAssembly::info],
    ".pat" => & [Max::info], ".patch" => & [Diff::info], ".pb" => & [PureBasic::info],
    ".pbi" => & [PureBasic::info], ".pbt" => & [PowerBuilder::info,
    ProtocolBufferTextFormat::info], ".pbtxt" => & [ProtocolBufferTextFormat::info],
    ".pc" => & [ProstarC::info, PkgConfig::info], ".pc.in" => & [PkgConfig::info], ".pck"
    => & [PLSQL::info], ".pcss" => & [PostCSS::info], ".pd" => & [PureData::info],
    ".pd_lua" => & [Lua::info], ".pddl" => & [PDDL::info], ".pde" => &
    [Processing::info], ".peggy" => & [PEGjs::info], ".pegjs" => & [PEGjs::info], ".pep"
    => & [Pep8::info], ".per" => & [GeneroPer::info], ".perl" => & [Perl::info], ".pfa"
    => & [PostScript::info], ".pgsql" => & [PLpgSQL::info], ".ph" => & [Perl::info],
    ".php" => & [Hack::info, PHP::info], ".php3" => & [PHP::info], ".php4" => &
    [PHP::info], ".php5" => & [PHP::info], ".phps" => & [PHP::info], ".phpt" => &
    [PHP::info], ".phtml" => & [HTMLpPHP::info], ".pic" => & [Pic::info], ".pig" => &
    [PigLatin::info], ".pike" => & [Pike::info], ".pir" => &
    ...
    [Red::info], ".reds" => & [Red::info, Redscript::info], ".reek" => & [YAML::info],
    ".reg" => & [WindowsRegistryEntries::info], ".regex" => & [RegularExpression::info],
    ".regexp" => & [RegularExpression::info], ".rego" => & [OpenPolicyAgent::info],
    ".rei" => & [Reason::info], ".religo" => & [ReasonLIGO::info], ".res" => &
    [ReScript::info, XML::info], ".resi" => & [ReScript::info], ".resource" => &
    [RobotFramework::info], ".rest" => & [ReStructuredText::info], ".rest.txt" => &
    [ReStructuredText::info], ".resx" => & [XML::info], ".rex" => & [REXX::info], ".rexx"
    => & [REXX::info], ".rg" => & [Rouge::info], ".rhtml" => & [HTMLpERB::info], ".ring"
    => & [Ring::info], ".riot" => & [Riot::info], ".rkt" => & [Racket::info], ".rktd" =>
    & [Racket::info], ".rktl" => & [Racket::info], ".rl" => & [Ragel::info], ".rmd" => &
    [RMarkdown::info], ".rmiss" => & [GLSL::info], ".rnh" => & [RUNOFF::info], ".rno" =>
    & [RUNOFF::info, Roff::info], ".rnw" => & [Sweave::info], ".robot" => &
    [RobotFramework::info], ".roc" => & [Roc::info], ".rockspec" => & [Lua::info],
    ".roff" => & [Roff::info], ".ron" => & [RON::info], ".ronn" => & [Markdown::info],
    ".rpgle" => & [RPGLE::info], ".rpy" => & [Python::info, RenPy::info], ".rq" => &
    [SPARQL::info], ".rs" => & [RenderScript::info, Rust::info, XML::info], ".rs.in" => &
    [Rust::info], ".rsc" => & [Rascal::info, RouterOSScript::info], ".rsh" => &
    [RenderScript::info], ".rss" => & [XML::info], ".rst" => & [ReStructuredText::info],
    ".rst.txt" => & [ReStructuredText::info], ".rsx" => & [R::info], ".rtf" => &
    [RichTextFormat::info], ".ru" => & [Ruby::info], ".ruby" => & [Ruby::info], ".rviz"
    => & [YAML::info], ".s" => & [Assembly::info, Motorola68KAssembly::info,
    UnixAssembly::info], ".sage" => & [Sage::info], ".sagews" => & [Sage::info], ".sail"
    => & [Sail::info], ".sarif" => & [JSON::info], ".sas" => & [SAS::info], ".sass" => &
    [Sass::info], ".sats" => & [ATS::info], ".sbatch" => & [Shell::info], ".sbt" => &
    [Scala::info], ".sc" => & [Scala::info, SuperCollider::info], ".scad" => &
    [OpenSCAD::info], ".scala" => & [Scala::info], ".scaml" => & [Scaml::info], ".scd" =>
    & [Markdown::info, SuperCollider::info], ".sce" => & [Scilab::info], ".scenic" => &
    [Scenic::info], ".sch" => & [Eagle::info, KiCadSchematic::info, Scheme::info,
    XML::info], ".sci" => & [Scilab::info], ".scm" => & [Scheme::info,
    TreeSitterQuery::info], ".sco" => & [CsoundScore::info], ".scpt" => &
    ...
    [XML::info], ".sls" => & [SaltStack::info, Scheme::info], ".slurm" => &
    [Shell::info], ".sma" => & [Pawn::info], ".smali" => & [Smali::info], ".smithy" => &
    [Smithy::info], ".smk" => & [Snakemake::info], ".sml" => & [StandardML::info], ".smt"
    => & [SMT::info], ".smt2" => & [SMT::info], ".snakefile" => & [Snakemake::info],
    ".snap" => & [JestSnapshot::info], ".snip" => & [VimSnippet::info], ".snippet" => &
    ...
    [JavaServerPages::info], ".talon" => & [Talon::info], ".target" => & [INI::info],
    ".targets" => & [XML::info], ".tcc" => & [Cpp::info], ".tcl" => & [Tcl::info],
    ".tcl.in" => & [Tcl::info], ".tcsh" => & [Tcsh::info], ".te" => &
    ...
    ".toit" => & [Toit::info], ".toml" => & [TOML::info], ".toml.example" => &
    [TOML::info], ".tool" => & [Shell::info], ".topojson" => & [JSON::info], ".tpb" => &
    [PLSQL::info], ".tpl" => & [GoTemplate::info, Smarty::info], ".tpp" => & [Cpp::info],
    ".tps" => & [PLSQL::info], ".tres" => & [GodotResource::info], ".trg" => &
    [PLSQL::info], ".trigger" => & [Apex::info, Shell::info], ".ts" => &
    [TypeScript::info, XML::info], ".tscn" => & [GodotResource::info], ".tsconfig.json"
    => & [JSONWithComments::info], ".tsp" => & [TSPLIBData::info, TypeSpec::info], ".tst"
    ...
    [AdblockFilterList::info, Text::info, VimHelpFile::info], ".txtpb" => &
    [ProtocolBufferTextFormat::info], ".txx" => & [Cpp::info], ".typ" => & [Typst::info,
    ...
    => & [VimScript::info], ".vmf" => & [ValveDataFormat::info], ".volt" => &
    [Volt::info], ".vrx" => & [GLSL::info], ".vs" => & [GLSL::info], ".vsh" => &
    [GLSL::info], ".vshader" => & [GLSL::info], ".vsixmanifest" => & [XML::info],
    ".vssettings" => & [XML::info], ".vstemplate" => & [XML::info], ".vtl" => &
    [VelocityTemplateLanguage::info], ".vto" => & [Vento::info], ".vtt" => &
    ...
    [WolframLanguage::info], ".wlk" => & [Wollok::info], ".wls" => &
    [WolframLanguage::info], ".wlt" => & [WolframLanguage::info], ".wlua" => &
